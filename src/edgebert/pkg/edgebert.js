...
export class WasmModel {
    ...
    constructor(weights_data, config_json, tokenizer_json) {
        try {
            ...
            const ptr0 = passArray8ToWasm0(weights_data, wasm.__wbindgen_export_2);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passStringToWasm0(config_json, wasm.__wbindgen_export_2, wasm.__wbindgen_export_3);
            const len1 = WASM_VECTOR_LEN;
            const ptr2 = passStringToWasm0(tokenizer_json, wasm.__wbindgen_export_2, wasm.__wbindgen_export_3);
    ...
    encode(texts, normalize) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passArrayJsValueToWasm0(texts, wasm.__wbindgen_export_2);
            const len0 = WASM_VECTOR_LEN;
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_wasmmodel_new = function(arg0) {
    ...
    imports.wbg.__wbindgen_cast_b75780d4760f5722 = function(arg0, arg1) {
        ...
        const ret = makeMutClosure(arg0, arg1, 128, __wbg_adapter_4);
        return addHeapObject(ret);
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('edgebert_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
